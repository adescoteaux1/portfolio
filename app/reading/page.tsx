      ...
      <div style={{ 
        ...
        <div style={{
          ...
          {filteredBooks.map((book, idx) => {
            ...
            const statusColor = book.status === 'read' ? colors.mysticalGlow : book.status === 'reading' ? colors.mediumGreen : 'rgba(255, 255, 255, 0.5)';
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                          {[...Array(5)].map((_, i) => (
                            <Star
                              key={i}
                              size={14}
                              fill={i < book.rating! ? colors.mysticalGlow : 'none'}
                              color={i < book.rating! ? colors.mysticalGlow : 'rgba(255, 255, 255, 0.3)'}
                            />
                          ))}
                        </div>
                      )}
